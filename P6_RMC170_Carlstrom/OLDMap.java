...
public class OLDMap {
    ...
    public OLDMap(String name, int size, double loadFactor) {
    ...
    public static void main(String[] args) {
        ...
        OLDMap cry = generateGraph();

        OLDMap m = generateRandomGraph(10, 0.8);
    ...
    public final boolean removeRoad(String fromBuilding, String toBuilding) {
        ...
        if (!roadExists(fromBuilding, toBuilding)) {
            ...
            // System.out.println("Can't remove " + toBuilding + "because code does not
            // think it exists");
            return false;
        }
...
/*
    public final int shortestPath(String source, String destination) {
        ...
        boolean[] SPT = new boolean[nodeCount];

        HeapNode[] heapNodes = new HeapNode[nodeCount];

        for (int i = 0; i < nodeCount; i++) {
            heapNodes[i] = new HeapNode();
            heapNodes[i].vertex = i;
            heapNodes[i].distance = LARGE;
        }

       // heapNodes[getBuilding(source)]
        //distance = 0;
    ...
    public static OLDMap generateGraph() {
        ...
        OLDMap m = new OLDMap(common[0], size, loadFactor);
    ...
    public static OLDMap generateRandomGraph(int size, double loadFactor) {
        String[] common = { "the", "of", "and", "a", "to", "in", "is", "you", "that", "it", "he",
                "was", "for", "on", "are", "as", "with", "his", "they", "I", "at", "be", "this", "have",
                "from", "or", "one", "had", "by", "word", "but", "not", "what", "all", "were", "we",
                "when", "your", "can", "said", "there", "use", "an", "each", "which", "she", "do",
            ...
            for (int i = 0; i < mapSize; i++) {
                ...
                while (temp != null) {
                    ...
                    if (temp.getLength() == 0) {
                        ...
                        str.append(
                                name + " -- " + temp.getName() + " [label=\"length is: " + temp.getLength() + "\"];");
                        str.append("\n");
                    }
